...
<body>
    <div class="container">
        ...
        <p class="text-center"> List of All Questions</p>
        <?php
        ...
        <div class="text-center">
            <a href="index.php" class="btn btn-dark" target="_blank">Attempt Online</a>
            <a href="Answers.php" class="btn btn-warning" target="_blank">Check Answer</a>
        </div>
    </div>
